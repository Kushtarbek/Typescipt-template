...
import type { Product1 } from 'src/types/product';
...
const products: Product1[] = [
  ...
  },
  {
    ...
    price: 95.0,
    quantity: 0,
    updatedAt: moment().subtract(2, 'days').subtract(8, 'hours').toDate().getTime(),
    variants: 1,
  },
  {
    ...
    price: 155.0,
    quantity: 48,
    updatedAt: moment().subtract(1, 'days').subtract(2, 'hours').toDate().getTime(),
    variants: 5,
  },
  {
