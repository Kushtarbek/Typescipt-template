...
import type { CustomerActivity, Order, Product, Project, Referral, Task } from 'src/types/reports';
  ...
  const orders: Order[] = [
    {
      ...
      createdAt: moment().subtract(7, 'minutes').subtract(10, 'seconds').toDate().getTime(),
      customer: {
    ...
    },
    {
      ...
      createdAt: moment().subtract(2, 'hours').subtract(12, 'minutes').subtract(50, 'seconds').toDate().getTime(),
      customer: {
    ...
    },
    {
      ...
      createdAt: moment().subtract(5, 'hours').subtract(39, 'minutes').subtract(12, 'seconds').toDate().getTime(),
      customer: {
    ...
    },
    {
      ...
      createdAt: moment().subtract(5, 'hours').subtract(46, 'minutes').subtract(21, 'seconds').toDate().getTime(),
      customer: {
    ...
    },
    {
      ...
      createdAt: moment().subtract(8, 'hours').subtract(19, 'minutes').subtract(54, 'seconds').toDate().getTime(),
      customer: {
    ...
    },
    {
      ...
      createdAt: moment().subtract(1, 'days').subtract(45, 'minutes').subtract(12, 'seconds').toDate().getTime(),
      customer: {
  ...
  const projects: Project[] = [
    {
      ...
      budget: 12500,
      createdAt: moment().subtract(2, 'hours').subtract(34, 'minutes').subtract(10, 'seconds').toDate().getTime(),
      currency: '$',
    ...
    },
    {
      ...
      budget: 15750,
      createdAt: moment().subtract(10, 'hours').subtract(56, 'minutes').subtract(25, 'seconds').toDate().getTime(),
      currency: '$',
    ...
    },
    {
      ...
      budget: 15750,
      createdAt: moment().subtract(1, 'days').subtract(30, 'minutes').subtract(50, 'seconds').toDate().getTime(),
      currency: '$',
    ...
    },
    {
      ...
      budget: 12500,
      createdAt: moment().subtract(1, 'days').subtract(4, 'minutes').subtract(30, 'seconds').toDate().getTime(),
      currency: '$',
      technologies: ['vue-js'],
    ...
    },
    {
      ...
      budget: 15750,
      createdAt: moment().subtract(1, 'days').subtract(11, 'minutes').subtract(6, 'seconds').toDate().getTime(),
      currency: '$',
