...
import { Avatar, Divider, IconButton, Input, Paper, Tooltip, makeStyles } from '@material-ui/core';
  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      ...
      <Paper className={classes.inputContainer} variant="outlined">
        <Input disableUnderline fullWidth onChange={handleChange} placeholder="Leave a message" />
      </Paper>
      <Tooltip title="Send">
