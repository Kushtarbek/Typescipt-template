...
const Checklist: FC<ChecklistProps> = ({ card, checklist, className, ...rest }) => {
  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      <Box display="flex">
        ...
        {editingName ? (
          <Box flexGrow={1}>
            <TextField value={name} fullWidth variant="outlined" onChange={handleNameChange} />
            <Box mt={1}>
              <Button color="primary" size="small" variant="contained" onClick={handleNameSave}>
                Save
              </Button>
          ...
          <Box display="flex" alignItems="center" flexGrow={1}>
            <Typography variant="h4" color="textPrimary" onClick={handleNameEdit}>
              {checklist.name}
            </Typography>
            <Box flexGrow={1} />
      ...
      <Box mt={1} display="flex" alignItems="center">
        ...
        <Box ml={2} flexGrow={1}>
          <LinearProgress variant="determinate" value={completePercentage} color="secondary" />
        </Box>
      </Box>
      <Box mt={3}>
