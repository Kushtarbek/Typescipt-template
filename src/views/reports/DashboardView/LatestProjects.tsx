  ...
  return (
    <Card className={clsx(classes.root, className)} {...rest}>
                ...
                <TableRow hover key={project.id}>
                  ...
                  <TableCell>
                    {project.technologies.map((technology) => (
                      <img alt="Tech" key={technology} className={classes.technology} src={technologyMap[technology]} />
                    ))}
                  </TableCell>
      ...
      <Box p={2} display="flex" justifyContent="flex-end">
        <Button component={RouterLink} size="small" to="/app/projects" endIcon={<NavigateNextIcon />}>
          See all
        </Button>
      </Box>
    </Card>
