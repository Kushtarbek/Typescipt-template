...
import type { Thread, ThreadMessage } from 'src/types/chat';
...
const MessageItem: FC<MessageItemProps> = ({ className, message, thread, ...rest }) => {
  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      <Box display="flex" maxWidth={500} ml={senderDetails.type === 'user' ? 'auto' : 0}>
