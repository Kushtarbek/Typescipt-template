...
const DetailHeader: FC<DetailHeaderProps> = ({ className, participants, ...rest }) => {
  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      <Box alignItems="center" display="flex">
        <AvatarGroup classes={{ avatar: otherParticipants.length > 1 ? classes.smallAvatar : null }} max={2}>
