...
import { Avatar, Box, Button, Dialog, TextField, Typography, makeStyles } from '@material-ui/core';
...
const ApplyModal: FC<ApplyModalProps> = ({ author, className, onApply, onClose, open, ...rest }) => {
  ...
  return (
    <Dialog maxWidth="lg" onClose={onClose} open={open}>
      <div className={clsx(classes.root, className)} {...rest}>
        ...
        <Box mt={3} p={3}>
          <Button onClick={handleApply} variant="contained" fullWidth color="primary">
            Apply for a role
          </Button>
        </Box>
      </div>
