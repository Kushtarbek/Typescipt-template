      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.references}>
          <View>
            ...
            <Text style={styles.body1}>{moment(invoice.dueDate).format('DD MMM YYYY')}</Text>
          </View>
          <View>
            <Text style={[styles.h5, styles.mb1]}>Date of issue</Text>
            <Text style={styles.body1}>{moment(invoice.issueDate).format('DD MMM YYYY')}</Text>
          </View>
          <View>
        ...
        <View style={styles.billing}>
          ...
          <Text style={styles.body1}>271 Richmond Rd, Grey Lynn, Auckland 1022, New Zealand</Text>
        </View>
