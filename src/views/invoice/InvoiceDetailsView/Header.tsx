...
import { Button, Breadcrumbs, Box, Link, Dialog, Grid, Typography, makeStyles, Hidden } from '@material-ui/core';
...
const Header: FC<HeaderProps> = ({ className, invoice, ...rest }) => {
  ...
  return (
    <Grid container justify="space-between" spacing={3} className={clsx(classes.root, className)} {...rest}>
      <Grid item>
