              ...
              {paginatedInvoices.map((invoice) => {
                ...
                return (
                  <TableRow hover key={invoice.id} selected={isInvoiceSelected}>
                    ...
                    <TableCell>
                      <Box display="flex" alignItems="center">
                        <Avatar className={classes.avatar}>{getInitials(invoice.customer.name)}</Avatar>
                        <Box ml={2}>
                          <Link variant="subtitle2" color="textPrimary" component={RouterLink} underline="none" to="#">
                    ...
                    <TableCell align="right">
                      ...
                      <IconButton component={RouterLink} to="/app/management/invoices/1">
                        <SvgIcon fontSize="small">
                          <ArrowRightIcon />
                        </SvgIcon>
                      </IconButton>
