                  ...
                  <TableRow hover key={customer.id} selected={isCustomerSelected}>
                    ...
                    <TableCell>
                      <Box display="flex" alignItems="center">
                        ...
                        <div>
                          <Link color="inherit" component={RouterLink} to="/app/management/customers/1" variant="h6">
                            {customer.name}
                          </Link>
                    ...
                    <TableCell align="right">
                      <IconButton component={RouterLink} to="/app/management/customers/1/edit">
                        <SvgIcon fontSize="small">
                          <EditIcon />
                        </SvgIcon>
                      </IconButton>
                      <IconButton component={RouterLink} to="/app/management/customers/1">
                        <SvgIcon fontSize="small">
                          <ArrowRightIcon />
                        </SvgIcon>
                      </IconButton>
