...
import { Drawer, Hidden, Box, List, Button, Divider, makeStyles } from '@material-ui/core';
...
const Sidebar: FC<SidebarProps> = ({ containerRef }) => {
  ...
  const content = (
    <div>
      <Box px={3} py={2}>
        <Button color="secondary" fullWidth variant="contained" onClick={handleComposeClick}>
          Compose
        </Button>
      </Box>
      <Divider />
