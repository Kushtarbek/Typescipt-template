...
import { ListItem, ButtonBase, Typography, makeStyles } from '@material-ui/core';
...
const LabelItem: FC<LabelItemProps> = ({ label, ...rest }) => {
  ...
  return (
    <ListItem className={classes.root} {...rest}>
      <ButtonBase activeClassName={classes.active} component={RouterLink} to={to} className={classes.content}>
