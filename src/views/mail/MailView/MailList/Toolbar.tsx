...
const Toolbar: FC<ToolbarProps> = ({ className, mails, onDeselectAll, onSelectAll, selectedMails, ...rest }) => {
    ...
    <div className={clsx(classes.root, className)} {...rest}>
      ...
      <Hidden smDown>
        ...
        <Paper className={classes.searchContainer} variant="outlined">
          ...
          <Input className={classes.searchInput} disableUnderline placeholder="Search mail" />
        </Paper>
