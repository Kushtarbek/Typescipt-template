...
import { Avatar, Box, Button, IconButton, Paper, TextareaAutosize, Tooltip, makeStyles } from '@material-ui/core';
      ...
      <Paper className={classes.textareaContainer} variant="outlined">
        ...
        <Box display="flex" alignItems="center" mt={2}>
          ...
          <Tooltip title="Attach image">
            <IconButton size="small" className={classes.action} onClick={handleAttach}>
              <AddPhotoIcon />
            </IconButton>
          </Tooltip>
