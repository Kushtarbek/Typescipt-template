...
import { Box, Hidden, IconButton, Input, Paper, Tooltip, makeStyles } from '@material-ui/core';
    ...
    <div className={clsx(classes.root, className)} {...rest}>
      ...
      <Hidden mdDown>
        <Paper className={classes.searchContainer} variant="outlined">
          ...
          <Input className={classes.searchInput} disableUnderline placeholder="Search message" />
        </Paper>
      </Hidden>
