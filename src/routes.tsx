...
const routes: Routes = [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        exact: true,
        path: '/app/account/team/edit',
        component: lazy(() => import('src/views/team/index')),
      },
      {
        exact: true,
        path: '/app/account/team/create',
        component: lazy(() => import('src/views/team/CreateNewTeamMember/index')),
      },
      {
        exact: true,
        path: '/app/account/saleschannel/create/:channelName',
        component: lazy(() => import('src/views/saleschannel/AddStore/index')),
      },
      {
        exact: true,
        path: '/app/account/saleschannel/edit/:channelName/:accountName',
        component: lazy(() => import('src/views/saleschannel/EditStore/index')),
      },
      {
        exact: true,
        path: '/app/calendar',
      ...
      {
        exact: true,
        path: '/app/management/returns',
        component: lazy(() => import('src/views/returns/ReturnsListView')),
      },
      {
        exact: true,
        path: '/app/management/returns/:orderId',
        component: lazy(() => import('src/views/returns/ReturnsDetailsView')),
      },
      {
        exact: true,
        path: '/app/management/products',
        component: lazy(() => import('src/views/product/ListView')),
      },
      // {
      //   exact: true,
      ...
      // },
      {
        exact: true,
        path: '/app/management/products/create',
        component: lazy(() => import('src/views/product/EditView')),
      },
      {
        exact: true,
      ...
      {
        exact: true,
        path: '/app/management/products/approve',
        component: lazy(() => import('src/views/product/ListView')),
      },
      {
        exact: true,
      ...
      {
        exact: true,
        path: '/app/campaigns/overview',
        component: lazy(() => import('src/views/campaign/OverviewView')),
      },
      {
        exact: true,
        path: '/app/campaigns/browse',
        component: lazy(() => import('src/views/campaign/CampaignBrowseView')),
      },
      {
        exact: true,
